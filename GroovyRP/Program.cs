...
namespace GroovyRP
{
    class Program
    {
        ...
        private static DiscordRpcClient GetBestClient(string[] album, Dictionary<String, DiscordRpcClient>.ValueCollection clients)
        {
                    ...
                    try
                    {
                        ...
                        for (int i = 2; i < lines.Length; i++)
                        {
                            if (lines[i].Contains("=="))
                            {
                                ...
                                Albums[Regex.Split(lines[i], @"==")[0]] = (string[])Albums[Regex.Split(lines[i], @"==")[0]].Append(Regex.Split(lines[i], @"==")[1]).ToArray();
